...
class FirebaseAuthManager( application: Application) {
    ...
    fun logOut() {
        ...
        Timber.i( "Farmersmarket : firebaseAuth Signed out")
        googleSignInClient.value!!.signOut()
        Timber.i( "Farmersmarket : googleSignInClient Signed out")
    ...
    fun firebaseAuthWithGoogle(acct: GoogleSignInAccount) {
        Timber.i( "Farmers Market firebaseAuthWithGoogle:" + acct.id!!)
